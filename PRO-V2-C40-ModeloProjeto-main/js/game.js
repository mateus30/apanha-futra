                ...
                player.getPlayerAtEnd();
                 ...
                 for(var plr in allPlayers){
                     ...
                     if(index === player.index){
                         ...
                         fill("red");
                         textSize(20);
                         text("jogador 1", player1.position.x,player1.position.y-10);//adicione o código para exibir o nome do jogador na respectiva cesta
                         text("jogador 2", player2.position.x,player2.position.y-10);
